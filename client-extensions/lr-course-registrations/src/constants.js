...
const UpcomingCoursesERC = "objects-bootcamps";
const RegistrationStatusERC = "objects-registration-status";
const UpcomingCourseDatesERC = "objects-bootcamp-dates";

export { UpcomingCoursesERC, RegistrationStatusERC, UpcomingCourseDatesERC }